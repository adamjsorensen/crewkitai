    ...
    <FinancialLayout title="Job Analysis">
      <Card className="border-dashed border-2">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            We're working hard to bring you powerful job analysis tools
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center pb-8 pt-2">
          ...
          <p className="text-center text-muted-foreground max-w-md">
            Job Analysis will help you track profit margins, costs, and performance
            metrics for each painting job you complete.
          </p>
        </CardContent>
      </Card>
    </FinancialLayout>
