...
import { PaintBucket, User, RefreshCw, Copy, Share2, ThumbsUp, ThumbsDown, Loader2, ZoomIn, MoreHorizontal, BookmarkIcon, CheckCircle2, PinIcon, Bot } from 'lucide-react';
...
const ChatMessage: React.FC<ChatMessageProps> = ({ message, onRegenerate, isMobile = false }) => {
  ...
  const keyPoints = !message.isStreaming ? getKeyPoints(message.content) : null;
